...
async function borrarEntradaSiExiste(page: Page): Promise<void> {
  ...
  // edición, o terminó con el registro reabierto para comprobar lo guardado),
  // vuelve al listado antes de buscar la fila.
...
test.describe('Certificados digitales', () => {
  test('Modificar una entrada sin tocar «Habilitado» la mantiene habilitada', async ({ page }) => {
