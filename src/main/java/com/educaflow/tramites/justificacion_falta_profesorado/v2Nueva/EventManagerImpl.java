package com.educaflow.tramites.justificacion_falta_profesorado.v2Nueva;
...
import com.educaflow.subsystem.expedientes.db.TipoResolucionJustificacionFaltaProfesoradoV2NUEVA;
...
import com.educaflow.subsystem.expedientes.db.JustificacionFaltaProfesoradoV2NUEVA;
import com.educaflow.subsystem.expedientes.db.repo.JustificacionFaltaProfesoradoV2NUEVARepository;
...
public class EventManagerImpl extends com.educaflow.subsystem.expedientes.services.eventmanager.EventManager<JustificacionFaltaProfesoradoV2NUEVA, EventManagerImpl.State, EventManagerImpl.Event,EventManagerImpl.Profile> implements TareaFirmaNotifier {

    private static final Rectangulo rectanguloPosicionFirmaPDFResolucion =new Rectangulo(75,280,400,20);

    private final JustificacionFaltaProfesoradoV2NUEVARepository repository;
    ...
    @Inject
    public EventManagerImpl(JustificacionFaltaProfesoradoV2NUEVARepository repository) {
        super(JustificacionFaltaProfesoradoV2NUEVA.class, State.class, Event.class,Profile.class);
        this.repository = repository;
    }

    @Override
    public void triggerInitialEvent(JustificacionFaltaProfesoradoV2NUEVA justificacionFaltaProfesorado, EventContext<Profile,State> eventContext) throws BusinessException {
    ...
    @WhenEvent
    public void triggerDelete(JustificacionFaltaProfesoradoV2NUEVA justificacionFaltaProfesorado, JustificacionFaltaProfesoradoV2NUEVA original, EventContext<Profile,State> eventContext) throws BusinessException {
        //eventContext.updateState(State.);
    }
    @WhenEvent
    public void triggerGuardarDatos(JustificacionFaltaProfesoradoV2NUEVA justificacionFaltaProfesorado, JustificacionFaltaProfesoradoV2NUEVA original, EventContext<Profile,State> eventContext) throws BusinessException {
        DocumentoPdf solicitudPdf = justificacionFaltaProfesorado.getDocumentoPdf(JustificacionFaltaProfesoradoV2NUEVA.TipoDocumentoPdf.SOLICITUD);
    ...
    @WhenEvent
    public void triggerBack(JustificacionFaltaProfesoradoV2NUEVA justificacionFaltaProfesorado, JustificacionFaltaProfesoradoV2NUEVA original, EventContext<Profile,State> eventContext) throws BusinessException {
    ...
    @WhenEvent
    public void triggerPresentar(JustificacionFaltaProfesoradoV2NUEVA exp, JustificacionFaltaProfesoradoV2NUEVA original, EventContext<Profile,State> eventContext) throws BusinessException {
    ...
    @WhenEvent
    public void triggerResolver(JustificacionFaltaProfesoradoV2NUEVA justificacionFaltaProfesorado, JustificacionFaltaProfesoradoV2NUEVA original, EventContext<Profile,State> eventContext) throws BusinessException {
        TipoResolucionJustificacionFaltaProfesoradoV2NUEVA tipoResolucion = justificacionFaltaProfesorado.getTipoResolucion();
        DocumentoPdf resolucion = justificacionFaltaProfesorado.getDocumentoPdf(JustificacionFaltaProfesoradoV2NUEVA.TipoDocumentoPdf.RESOLUCION);
...
/***************************************************************************************/
    ...
    @OnEnterState
    public void onEnterEntradaDatos(JustificacionFaltaProfesoradoV2NUEVA justificacionFaltaProfesorado, EventContext<Profile,State> eventContext) {

    }
    @OnEnterState
    public void onEnterPendientePresentacion(JustificacionFaltaProfesoradoV2NUEVA justificacionFaltaProfesorado, EventContext<Profile,State> eventContext) {

    }
    @OnEnterState
    public void onEnterPendienteResolucion(JustificacionFaltaProfesoradoV2NUEVA justificacionFaltaProfesorado, EventContext<Profile,State> eventContext) {

    }
    @OnEnterState
    public void onEnterAceptado(JustificacionFaltaProfesoradoV2NUEVA justificacionFaltaProfesorado, EventContext<Profile,State> eventContext) {

    }
    @OnEnterState
    public void onEnterRechazado(JustificacionFaltaProfesoradoV2NUEVA justificacionFaltaProfesorado, EventContext<Profile,State> eventContext) {
