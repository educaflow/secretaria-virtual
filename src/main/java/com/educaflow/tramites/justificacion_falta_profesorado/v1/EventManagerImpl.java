...
public class EventManagerImpl extends com.educaflow.subsystem.expedientes.services.eventmanager.EventManager<JustificacionFaltaProfesoradoV1, EventManagerImpl.State, EventManagerImpl.Event,EventManagerImpl.Profile> implements TareaFirmaNotifier {
    ...
    @Override
    public void triggerInitialEvent(JustificacionFaltaProfesoradoV1 justificacionFaltaProfesorado, EventContext<Profile,State> eventContext) throws BusinessException {
    ...
    @WhenEvent
    public void triggerDelete(JustificacionFaltaProfesoradoV1 justificacionFaltaProfesorado, JustificacionFaltaProfesoradoV1 original, EventContext<Profile,State> eventContext) throws BusinessException {
        //eventContext.updateState(State.);
    }
    @WhenEvent
    public void triggerGuardarDatos(JustificacionFaltaProfesoradoV1 justificacionFaltaProfesorado, JustificacionFaltaProfesoradoV1 original, EventContext<Profile,State> eventContext) throws BusinessException {
    ...
    @WhenEvent
    public void triggerBack(JustificacionFaltaProfesoradoV1 justificacionFaltaProfesorado, JustificacionFaltaProfesoradoV1 original, EventContext<Profile,State> eventContext) throws BusinessException {
    ...
    @WhenEvent
    public void triggerPresentar(JustificacionFaltaProfesoradoV1 exp, JustificacionFaltaProfesoradoV1 original, EventContext<Profile,State> eventContext) throws BusinessException {
    ...
    @WhenEvent
    public void triggerResolver(JustificacionFaltaProfesoradoV1 justificacionFaltaProfesorado, JustificacionFaltaProfesoradoV1 original, EventContext<Profile,State> eventContext) throws BusinessException {
...
/***************************************************************************************/
    ...
    @OnEnterState
    public void onEnterEntradaDatos(JustificacionFaltaProfesoradoV1 justificacionFaltaProfesorado, EventContext<Profile,State> eventContext) {

    }
    @OnEnterState
    public void onEnterPendientePresentacion(JustificacionFaltaProfesoradoV1 justificacionFaltaProfesorado, EventContext<Profile,State> eventContext) {

    }
    @OnEnterState
    public void onEnterPendienteResolucion(JustificacionFaltaProfesoradoV1 justificacionFaltaProfesorado, EventContext<Profile,State> eventContext) {

    }
    @OnEnterState
    public void onEnterAceptado(JustificacionFaltaProfesoradoV1 justificacionFaltaProfesorado, EventContext<Profile,State> eventContext) {

    }
    @OnEnterState
    public void onEnterRechazado(JustificacionFaltaProfesoradoV1 justificacionFaltaProfesorado, EventContext<Profile,State> eventContext) {
