package com.educaflow.tramites.profesores.justificacion_falta_profesorado.futuro.v2;
...
import com.educaflow.subsystem.expedientes.db.JustificacionFaltaProfesoradoV2;
import com.educaflow.subsystem.expedientes.db.repo.JustificacionFaltaProfesoradoV2Repository;
...
public class EventManagerImpl extends com.educaflow.subsystem.expedientes.services.eventmanager.EventManager<JustificacionFaltaProfesoradoV2, EventManagerImpl.State, EventManagerImpl.Event,EventManagerImpl.Profile> implements TareaFirmaNotifier {

    private static final Rectangulo rectanguloPosicionFirmaPDFResolucion =new Rectangulo(75,280,400,20);

    private final JustificacionFaltaProfesoradoV2Repository repository;
    ...
    @Inject
    public EventManagerImpl(JustificacionFaltaProfesoradoV2Repository repository) {
        super(JustificacionFaltaProfesoradoV2.class, State.class, Event.class,Profile.class);
        this.repository = repository;
    }

    @Override
    public void triggerInitialEvent(JustificacionFaltaProfesoradoV2 justificacionFaltaProfesorado, EventContext<Profile,State> eventContext) throws BusinessException {
    ...
    @WhenEvent
    public void triggerDelete(JustificacionFaltaProfesoradoV2 justificacionFaltaProfesorado, JustificacionFaltaProfesoradoV2 original, EventContext<Profile,State> eventContext) throws BusinessException {
        //eventContext.updateState(State.);
    }
    @WhenEvent
    public void triggerGuardarDatos(JustificacionFaltaProfesoradoV2 justificacionFaltaProfesorado, JustificacionFaltaProfesoradoV2 original, EventContext<Profile,State> eventContext) throws BusinessException {
        DocumentoPdf solicitudPdf = justificacionFaltaProfesorado.getDocumentoPdf(JustificacionFaltaProfesoradoV2.TipoDocumentoPdf.SOLICITUD);
    ...
    @WhenEvent
    public void triggerBack(JustificacionFaltaProfesoradoV2 justificacionFaltaProfesorado, JustificacionFaltaProfesoradoV2 original, EventContext<Profile,State> eventContext) throws BusinessException {
    ...
    @WhenEvent
    public void triggerPresentar(JustificacionFaltaProfesoradoV2 exp, JustificacionFaltaProfesoradoV2 original, EventContext<Profile,State> eventContext) throws BusinessException {
    ...
    @WhenEvent
    public void triggerResolver(JustificacionFaltaProfesoradoV2 justificacionFaltaProfesorado, JustificacionFaltaProfesoradoV2 original, EventContext<Profile,State> eventContext) throws BusinessException {
        TipoResolucionJustificacionFaltaProfesoradoV2 tipoResolucion = justificacionFaltaProfesorado.getTipoResolucion();
        DocumentoPdf resolucion = justificacionFaltaProfesorado.getDocumentoPdf(JustificacionFaltaProfesoradoV2.TipoDocumentoPdf.RESOLUCION);
...
/***************************************************************************************/
    ...
    @OnEnterState
    public void onEnterEntradaDatos(JustificacionFaltaProfesoradoV2 justificacionFaltaProfesorado, EventContext<Profile,State> eventContext) {

    }
    @OnEnterState
    public void onEnterPendientePresentacion(JustificacionFaltaProfesoradoV2 justificacionFaltaProfesorado, EventContext<Profile,State> eventContext) {

    }
    @OnEnterState
    public void onEnterPendienteResolucion(JustificacionFaltaProfesoradoV2 justificacionFaltaProfesorado, EventContext<Profile,State> eventContext) {

    }
    @OnEnterState
    public void onEnterAceptado(JustificacionFaltaProfesoradoV2 justificacionFaltaProfesorado, EventContext<Profile,State> eventContext) {

    }
    @OnEnterState
    public void onEnterRechazado(JustificacionFaltaProfesoradoV2 justificacionFaltaProfesorado, EventContext<Profile,State> eventContext) {
