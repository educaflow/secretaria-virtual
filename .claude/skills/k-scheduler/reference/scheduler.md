...
The Axelor Open Platform integrates a feature rich [quartz scheduler](https://quartz-scheduler.org/) library for job scheduling.
...
The Axelor Open Platform automatically configures the JDBC JobStore to use the application's main database and creates the necessary Quartz tables (`qrtz_*`) if they don't exist on application startup.
...
- `cron` - the [cron](https://www.quartz-scheduler.org/documentation/quartz-2.3.0/tutorials/crontrigger.html) string to schedule the job
