...
1. Lee tu `test-e2e-desc_NN.md` (qué debía pasar) y el bloque `=== FALLO ===` del ejecutor (qué pasó en la UI).
...
- modificar `test-e2e-desc.md` ni los ficheros de `test-e2e/` para que el test pase (es trampa);
