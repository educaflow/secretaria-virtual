...
- RES-SolicitudCertificado-001 — Una solicitud pertenece siempre a un alumno del centro
- RES-SolicitudCertificado-002 — La fecha de resolución no puede ser anterior a la fecha de solicitud

## Campos calculados

- CC-SolicitudCertificado-001 — fecha de solicitud
  - momento: escritura
...
- VAL-SolicitudCertificado-001 — El tipo de certificado está indicado
  - mensaje: "El tipo de certificado es obligatorio"

**Reglas de negocio:**

- RN-SolicitudCertificado-001 — Registrar la solicitud en el registro de entrada
  - fase: antes_de_commit
- RN-SolicitudCertificado-002 — Avisar a la secretaría del centro
...
- VAL-SolicitudCertificado-002 — La solicitud está en estado PENDIENTE
  - mensaje: "Solo se pueden emitir solicitudes pendientes"
- VAL-SolicitudCertificado-003 — El usuario pertenece a la secretaría del centro
  - actor: [SECRETARIO, VICESECRETARIO]
  - mensaje: "No tiene permisos para emitir certificados"

**Reglas de negocio:**

- RN-SolicitudCertificado-003 — Generar el documento del certificado a partir de la plantilla
  - fase: antes_de_commit
- RN-SolicitudCertificado-004 — Enviar al alumno un correo con el certificado emitido
  - fase: después_de_commit
