...
|---------------------|---------------------------------------------------------------------|--------------------------|--------------------|
| Crear (insert)      | Siempre (manual desde la pantalla admin u otros sistemas)           | V-TareaCorreo-001..005             | R-TareaCorreo-001              |
...
| R-TareaCorreo-003 | Intenta el envío SMTP; si sale bien, marca estado=ENVIADO y fechaEnvioOk=ahora                       | TareaCorreo | Procesar pendientes | —       | Solo proceso periódico; caso de éxito                                 |
| R-TareaCorreo-004 | Si el envío falla, marca estado=FALLADO, incrementa numIntentos, actualiza fechaUltimoIntento y logErrores | TareaCorreo | Procesar pendientes | —       | Solo proceso periódico; caso de fallo                                 |
