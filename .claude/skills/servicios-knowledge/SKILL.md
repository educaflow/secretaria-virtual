...
public class MiEntidadServiceImpl extends DefaultModelService<MiEntidad> implements MiEntidadService {
    ...
    private void fireActionRule_PreInsertAccion(MiEntidad entidad) {
        // Efecto secundario antes de persistir: asignar fecha, número, etc.
    }

    private void fireActionRule_PostInsertAccion(MiEntidad entidad) {
        // Efecto secundario tras persistir: notificaciones, callbacks, etc.
    }

    private void fireActionRule_PreUpdateAccion(MiEntidad entidad, MiEntidad entidadOriginal) {
        // ...
    }

    private void fireActionRule_PostUpdateAccion(MiEntidad entidad, MiEntidad entidadOriginal) {
        // ...
    }
}
```
