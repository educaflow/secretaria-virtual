...
|---|---|
| `target` | [XPath expression](https://www.w3.org/TR/1999/REC-xpath-19991116/) to select the target element of the extension operation (extend operation is performed on the first match only) |
...
| `source` | [XPath expression](https://www.w3.org/TR/1999/REC-xpath-19991116/) to select the source element of the `move` operation |
