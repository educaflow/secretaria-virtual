...
**Alcance de esta tarea:** solo la clase `com.educaflow.secretariavirtual.datademo.TareaFirmaDemoNotifier`.
El `TareaFirmaDemoLoader` que aparece en el mismo bloque del diseño lo materializa la Tarea 10; aquí se copia
el bloque entero **verbatim** porque el diseño describe las dos clases juntas.
