...
para la clase `com.educaflow.subsystem.firmas.util.SituacionFirmaBuilder`.
...
- Ubicación de salida: `src/test/java/com/educaflow/subsystem/firmas/util/SituacionFirmaBuilderTest.java`.
...
`design/test-unit-desc.md`, sección **`Clase: com.educaflow.subsystem.firmas.util.SituacionFirmaBuilder — helper (nueva)`** (líneas 107–164 del fichero), junto con las secciones
