...
para la clase `com.educaflow.subsystem.firmas.controller.TareaFirmaController`.
...
- Ubicación de salida: `src/test/java/com/educaflow/subsystem/firmas/controller/TareaFirmaControllerTest.java`.
...
`design/test-unit-desc.md`, sección **`Clase: com.educaflow.subsystem.firmas.controller.TareaFirmaController — controlador (modificada)`** (líneas 380–426 del fichero), junto con las secciones
