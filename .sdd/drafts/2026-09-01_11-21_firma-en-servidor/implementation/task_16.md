...
para la clase `com.educaflow.secretariavirtual.datademo.TareaFirmaDemoLoader`.
...
- Ubicación de salida: `src/test/java/com/educaflow/secretariavirtual/datademo/TareaFirmaDemoLoaderTest.java`.
...
`design/test-unit-desc.md`, sección **`Clase: com.educaflow.secretariavirtual.datademo.TareaFirmaDemoLoader — helper (nueva)`** (líneas 428–469 del fichero), junto con las secciones
